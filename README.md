...
| 符号 | 例子 | 作用 |
| :--- | :--- | :--- |
| `//` 整除 (Floor Div) | `7 // 2 = 3` | 取商，用于“砍掉尾巴”或“求行号”。 |
...
| 题目操作 | 谁是新的头？ | 需要 Dummy 吗？ | 为什么？ |
| :--- | :--- | :--- | :--- |
| 删除节点 | 可能是原头，也可能不是 | 要 | 假如把头删了，我需要 Dummy 告诉我新头是谁。 |
| 交换/排序 | 肯定不是原来的头了 | 要 | 原来的头跑后面去了，我需要 Dummy 指向新的老大。 |
| 合并链表 | 不确定 | 要 | 我需要一个“桩子”来从零开始挂车厢。 |
| 反转链表 | 也就是原来的尾巴 | 不要 | `prev` 变量自然会变成新的头。 |
| 找环/中点 | 还是原来的头 | 不要 | 只是读，不改结构。 |
```python
